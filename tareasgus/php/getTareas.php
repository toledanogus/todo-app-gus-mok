...
if ($x->filter === 'todas') {
    ...
    $respuesta = mysqli_query($conn, "(SELECT titulo, descripcion, prioridad, completada, fechalimite, categoria, id FROM tareasgus) UNION ALL (SELECT titulo, descripcion, prioridad, completada, fechalimite, categoria, id FROM tareasjuntos) ORDER BY fechalimite ASC, prioridad DESC");
